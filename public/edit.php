...
?>
<?php
    $title = "Modifier le film {$film['id']}: {$film['title']}";
    $description = "Modification du film: {$film['title']}";
    $keywords = "Cinema, repertoire, modification, film, dwwm22";
?>
                ...
                <div class="col-md-6 col-lg-4 mx-auto shadow bg-white p-4 rounded">
                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" id="title" name="title" class="form-control" autofocus value="<?= isset($_SESSION['old']['title']) ? htmlspecialchars($_SESSION['old']['title']) : htmlspecialchars($film['title']); unset($_SESSION['old']['title']); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="rating">Note / 5</label>
                            <input type="number" step=".5" min="0" max="5" id="rating" name="rating" class="form-control" value="<?= isset($_SESSION['old']['rating']) ? htmlspecialchars($_SESSION['old']['rating']) : htmlspecialchars((float) $film['rating']); unset($_SESSION['old']['rating']); ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input formnovalidate type="submit" class="btn btn-primary shadow w-100" value="Modifier">
                        </div>
                    </form>
                </div>
            </div>
